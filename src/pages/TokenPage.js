...
function TokenPage({ address, history }) {
  ...
  return (
    <PageWrapper className="token-main-page">
      ...
      <ContentWrapper className="main-container">
        <RowBetween className="search-bar" style={{ flexWrap: 'wrap', alingItems: 'start' }}>
        ...
        <WarningGrouping disabled={!dismissed && listedTokens && !listedTokens.includes(address)}>
          <DashboardWrapper style={{ marginTop: below1080 ? '0' : '0' }}>
            ...
            <>
              ...
              <PanelWrapper className="top-row" style={{ marginTop: below1080 ? '0' : '0rem' }}>
                {/* {below1080 && price && ( */}
                <Panel>
                  <AutoColumn gap="20px">
                    <RowBetween>
                    ...
                    <RowBetween className="my-flex-wrap" align="flex-end">
                      {' '}
